...
IUSE="+closure-compile component-build cups cpu_flags_arm_neon gtk3 +hangouts kerberos pic +proprietary-codecs pulseaudio selinux +suid +system-ffmpeg +system-icu +system-libvpx +tcmalloc ungoogled widevine"
...
extra/debian/warnings/initialization.patch
...
src_prepare() {
	...
	use gtk3 || eapply "${FILESDIR}/chromium-81-gtk2.patch"
