...
IUSE="component-build cups cpu_flags_arm_neon debug +gtk2 gtk3 gtk4 +hangouts headless +js-type-check kerberos libcxx official pic +proprietary-codecs pulseaudio screencast selinux +suid +system-ffmpeg +system-harfbuzz +system-icu +system-png ungoogled vaapi wayland widevine"
REQUIRED_USE="
...
src_prepare() {
	...
	use gtk2 && eapply "${FILESDIR}/chromium-$(ver_cut 1)-gtk2.patch"
