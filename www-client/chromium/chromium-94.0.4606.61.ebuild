...
IUSE="component-build cups cpu_flags_arm_neon debug gtk3 +hangouts headless +js-type-check kerberos official pic +proprietary-codecs pulseaudio screencast selinux +suid +system-ffmpeg +system-harfbuzz +system-icu ungoogled vaapi wayland widevine"
REQUIRED_USE="
...
extra/ungoogled-chromium/searx.patch
...
src_prepare() {
	...
	use ungoogled && PATCHES+=("${FILESDIR}/chromium-94-safe-browsing-fix.patch")

	default

	use gtk3 || eapply "${FILESDIR}/chromium-$(ver_cut 1)-gtk2.patch"
