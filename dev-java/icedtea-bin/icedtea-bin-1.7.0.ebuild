...
FEDORA_V="1.7.0.0-0.19.b21.snapshot.fc8.i586"
BASE_URI="http://fedora.tu-chemnitz.de/pub/linux/fedora/linux/releases/8/Fedora/i386/os/Packages"
...
src_install() {
    dodir /usr/lib
    cp -a usr/lib/jvm* ${D}/usr/lib

    if use nsplugin; then
        install_mozilla_plugin \
        /usr/lib/jvm/java-${PV}-icedtea-${PV}.0/jre/lib/i386/gcjwebplugin.so
    fi
